...
// 필요한 데이터
//	데이터 베이스의 회원 비밀번호 (암호화된 비밀번호)
//	로그인 요청 정보 중 비밀번호 (암호화되지 않은 비밀번호)
//	로그인 요청 정보 중 비밀번호를 암호화 하기 위한 salt 정보
public class SecurityPasswordEncoder implements PasswordEncoder {

	// 로그인 요청 정보 중 비밀번호를 암호화 하는 코드
	// @param rawPassword: 암호화 되어잇지 않은 평문 비밀번호
	// @return 암호화된 비밀번호
	@Override
	...
	// 로그인 정보 중 평문 비밀번호와 데이터베이스에 있는 암호화된 비밀번호가 일치하는지 검사
	// 평문 => 암호화 => DB 암호와 비교
	@Override
